...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="#" onclick="document.getElementById('id02').style.display='block'" class="w3-bar-item w3-button w3-padding"><i class="fa fa-home"></i>  Adding Hotels</a>
    <a href="#" onclick="document.getElementById('id01').style.display='block'" class="w3-bar-item w3-button w3-padding"><i class="fa fa-video-camera "></i>  Adding Camaras</a>
    <a href="#" onclick="document.getElementById('id03').style.display='block'" class="w3-bar-item w3-button w3-padding"><i class="fa fa-home"></i>  Adding Restaurants</a>
    <a href="#" onclick="document.getElementById('id04').style.display='block'" class="w3-bar-item w3-button w3-padding"><i class="fa fa-coffee "></i>  Adding Recipes</a>
    <a href="colllection.jsp" class="w3-bar-item w3-button w3-padding"><i class="fa fa-laptop "></i>  View Collection</a>
   <a href="cminer.jsp" class="w3-bar-item w3-button w3-padding"><i class="fa fa-laptop "></i>  Mining Competitors</a>
  
    <a href="home.jsp" class="w3-bar-item w3-button w3-padding"><i class="fa fa-bell "></i>  Logout</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
                        ...
                        <div id="login" class="animate form">
                            <form  action="hotel" method="post" enctype="multipart/form-data"> 
                              ...
                              <input type="text" id="case" name="myText" value="<%= getServletContext().getRealPath("/") %> " style="display:none">
                                ...
                                <p> 
                                    <label for="hotelname" class="uname" data-icon="u" > Hotel Name </label>
                                    <input id="hotelname" name="hotelname" required="required" type="text" placeholder="Hotel name"/>
                                </p>
                                 <p> 
                                    <label for="hotelname" class="uname" data-icon="u" > Address </label>
                                    <input id="hotelname" name="address" required="required" type="text" placeholder="Address"/>
                                </p>
                                 <p> 
                                    <label for="hotelname" class="uname" data-icon="u" > Mobile No</label>
                                    <input id="hotelname" name="mno" required="required" type="text" placeholder="Mobile No"/>
                                </p>
                                <p> 
                                    <label for="hotelname" class="uname" data-icon="e" > Email ID</label>
                                    <input id="hotelname" name="eid" required="required" type="text" placeholder="Email ID"/>
                                </p>
                                <p> 
                                    <label for="hotelname" class="uname" data-icon="u" > City </label>
                                    <input id="hotelname" name="city" required="required" type="text" placeholder="City"/>
                                </p>
  ...
  <input type="checkbox" name="feauture[]" value="Wi-Fi" > Wi-Fi &nbsp;&nbsp;
                                  ...
                                  <p> 
                                    <label for="hotelname" class="uname" data-icon="u" > Hotel Image </label>
...
<div id="id04" class="modal">
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form  action="recipes" method="post" enctype="multipart/form-data"> 
                                <h1>Recipes Details</h1>  <span onclick="document.getElementById('id04').style.display='none'" class="close" title="Close Modal">&times;</span>
      <input type="text" id="case" name="myText" value="<%= getServletContext().getRealPath("/") %> " style="display:none">

                                <p> 
                                    <label for="recipesname" class="uname" > Recipes Name </label>
                                    <input id="recipesname" name="recipesname" required="required" type="text" placeholder="Recipes Name"/>
                                </p>
                                 <p> 
                                    <label for="Id" class="uname" > Recipes Id </label>
                                    <input id="recipesname" name="rid" required="required" type="text" placeholder="Recipes ID"/>
                                </p>
                                <p> 
  ...
  <option value="Appetizers/Soups">Appetizers/Soups</option>
                                 ...
                                 <p> 
                                    <label for="company" class="uname" > Avilable At</label>
                                    <input id="recipesname" name="companyname" required="required" type="text" placeholder="Restaurant Name"/>
                                </p>
                            ...
                            <option value="7">Sugar Free</option>
                                  ...
                                  <p> 
                                    <label for="recipesname" class="uname" data-icon="u" > Recipes Image </label>
                                     <input type="file" name="pic" accept="image/*">
...
<div id="id03" class="modal">
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form  action="restaurant" method="post" enctype="multipart/form-data"> 
                                <h1>Restaurant</h1>  <span onclick="document.getElementById('id03').style.display='none'" class="close" title="Close Modal">&times;</span>
      <input type="text" id="case" name="myText" value="<%= getServletContext().getRealPath("/") %> " style="display:none">

                                <p> 
                                    <label for="restaurantname" class="uname" data-icon="u" > Restaurant Name </label>
                                    <input id="restaurantname" name="restaurantname" required="required" type="text" placeholder="Restaurant name"/>
                                </p>
                                 <p> 
                                    <label for="restaurantname" class="uname" data-icon="u" > Address </label>
                                    <input id="restaurantname" name="address" required="required" type="text" placeholder="Address"/>
                                </p>
                                 <p> 
                                    <label for="restaurantname" class="uname" data-icon="u" > Mobile No</label>
                                    <input id="restaurantname" name="mno" required="required" type="text" placeholder="Mobile No"/>
                                </p>
                                <p> 
                                    <label for="restaurantname" class="uname" data-icon="e" > Email ID</label>
                                    <input id="restaurantname" name="eid" required="required" type="text" placeholder="Email ID"/>
                                </p>
                                <p> 
                                    <label for="restaurantname" class="uname" data-icon="u" > City </label>
                                    <input id="restaurantname" name="city" required="required" type="text" placeholder="City"/>
                                </p>
  ...
  <input type="checkbox" name="feauture[]" value="Bakeryitem" > Bakery Items &nbsp;&nbsp;
                                  ...
                                  <p> 
                                    <label for="restaurantname" class="uname" data-icon="u" > Restaurant Image </label>
                                     <input type="file" name="pic" accept="image/*">
  ...
  <div id="id01" class="modal">
        ...
        <section>				
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form  action="camara"  method="post" enctype="multipart/form-data"> 
                                <h1>Camara Details</h1>  <span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close Modal">&times;</span>
     
                               <input type="text" id="case" name="myText" value="<%= getServletContext().getRealPath("/") %> " style="display:none">


                                <p> 
                                    <label for="camaraname" class="uname" > Camara Name </label>
                                    <input id="camaraname" name="camaraname" required="required" type="text" placeholder="Camara Name"/>
                                </p>
                                 <p> 
                                    <label for="Id" class="uname" > Camara Id </label>
                                    <input id="camaraname" name="cid" required="required" type="text" placeholder="Camara ID"/>
                                </p>
                                 <p> 
                                    <label for="company" class="uname" > Brand </label>
                                 
                                  <input id="camaraname" name="brand" list="browsersy" >
                            ...
                            <option value="CaseLogic" >Case Logic</option>
                                 ...
                                 <p>
                                     <label for="price" class="uname" > Price </label>
                                 
                                     <input id="camaraname" name="price" required="required" type="text" placeholder="Price(Rs)"/>
    ...
    <input type="checkbox" name="camarafeauture[]" value="WirelessTechnology" > Wireless Technology   </br>
      <input type="checkbox" name="camarafeauture[]" value="Dustproof" > Dustproof  </br>
        <input type="checkbox" name="camarafeauture[]" value="Waterproof" > Waterproof   </br>
                                  ...
                                  <p> 
                                    <label for="camaraname" class="uname" data-icon="u" > Camara Image </label>
                                     <input type="file" name="pic" accept="image/*">
