...
try {
     ...
     Map<String,String> camara1=new HashMap<String,String>(); 
      Map<String,String> camara1ss=new HashMap<String,String>(); 
       Map<String,Integer> map=new HashMap<String,Integer>(); 
        Map< Long,String> common=new HashMap< Long,String>(); 
          
     ArrayList<String> lst = new ArrayList<String>();
    ArrayList<String> lst1 = new ArrayList<String>();
     ArrayList<String> camara = new ArrayList<String>();
    ArrayList<String> lstc = new ArrayList<String>();
Class.forName("com.mysql.jdbc.Driver").newInstance();
Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/mining", "root", "root");
Statement st = conn.createStatement();
PreparedStatement ps3=conn.prepareStatement("select * from camara");
    ...
    camara.add(rs.getString(2));
    camara1.put(rs.getString(2),rs.getString(10));
...
int l=0;
InputStream sImage;
PreparedStatement ps=conn.prepareStatement("select * from camara1");
            out.print("<table  border=0>");          
    ...
    lst.add(rs1.getString(8));
    
   cal=cal+rs1.getString(8)+" ";
...
Object[] st2 = lst.toArray();
  ...
  <tr>
    ...
    <th width="90%">Feature Of Interest</th>
  </tr>
      <%
      int kl=0;
      int nj=0;
...
for (String temp : lst) {
    ...
    int i=0;
    PreparedStatement ps1=conn.prepareStatement("select * from camara1 where ovfeauture='"+temp+"'");
            out.print("<table  border=0>");          
...
<tr> <td width="10%">q<%=kl%> </td>
    
    <td width="15%"><%=i%></td>
    <td width="90%"><%=test1%></td>
</tr>
  <%
...
%>
  ...
  <div class="w3-panel"  id="pyramid">
          <br>
      <br>
Common segments for Camara pairs
    <br>
      <br>
<table align="center">
  <tr>
    <th width="20%">Camara Pairs</th>
...
for (String temp : camara) {
count=count+1;
System.out.println(temp);
int count1=0;
for (String temp2 : camara) {
count1=count1+1;
if(count1>=count+1)
{
...
for (Map.Entry<String, String> entry : camara1.entrySet()) {
