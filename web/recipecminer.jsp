...
Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/mining", "root", "root");
Statement st = conn.createStatement();
PreparedStatement ps3=conn.prepareStatement("select * from recipes");
    ...
    hotel1.put(rs.getString(2),rs.getString(13));
...
int l=0;
InputStream sImage;
PreparedStatement ps=conn.prepareStatement("select * from recipes1");
            out.print("<table  border=0>");          
    ...
    lst.add(rs1.getString(10));
    
   cal=cal+rs1.getString(10)+" ";
...
for (String temp : lst) {
    ...
    int i=0;
    PreparedStatement ps1=conn.prepareStatement("select * from recipes1 where ovfeauture='"+temp+"'");
            out.print("<table  border=0>");          
