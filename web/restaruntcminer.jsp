...
try {
     ...
     Map<String,String> restarunt1=new HashMap<String,String>(); 
      Map<String,String> restarunt1ss=new HashMap<String,String>(); 
       Map<String,Integer> map=new HashMap<String,Integer>(); 
        Map< Long,String> common=new HashMap< Long,String>(); 
          
     ArrayList<String> lst = new ArrayList<String>();
    ArrayList<String> lst1 = new ArrayList<String>();
     ArrayList<String> restarunt = new ArrayList<String>();
    ArrayList<String> lstc = new ArrayList<String>();
Class.forName("com.mysql.jdbc.Driver").newInstance();
Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/mining", "root", "root");
Statement st = conn.createStatement();
PreparedStatement ps3=conn.prepareStatement("select * from restaurant");
    ...
    restarunt.add(rs.getString(2));
    restarunt1.put(rs.getString(2),rs.getString(7));
...
int l=0;
InputStream sImage;
PreparedStatement ps=conn.prepareStatement("select * from restaurant1");
            out.print("<table  border=0>");          
...
for (String temp : lst) {
    ...
    int i=0;
    PreparedStatement ps1=conn.prepareStatement("select * from restaurant1 where Features='"+temp+"'");
            out.print("<table  border=0>");          
...
%>
  ...
  <div class="w3-panel"  id="pyramid">
          <br>
      <br>
Common segments for Restarunt pairs
    <br>
      <br>
<table align="center">
  <tr>
    <th width="20%">Restarunt Pairs</th>
...
for (String temp : restarunt) {
count=count+1;
int count1=0;
for (String temp2 : restarunt) {
count1=count1+1;
if(count1>=count+1)
{
...
for (Map.Entry<String, String> entry : restarunt1.entrySet()) {
