...
ResultSet rs=st.executeQuery("SELECT Id FROM camara");
...
int l=0;
InputStream sImage;
PreparedStatement ps=conn.prepareStatement("select * from camara");
       ...
       String path="gallery/"+rs1.getString(11);
          String[] jj=rs1.getString(10).split(",");
       String value="";
       for(String kk : jj)
       {
           value=value+kk+"\n,";
    ...
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-footer" align="center"><%=value%></div>
      </div>
    </div>
