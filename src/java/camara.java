...
public class camara extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String name=request.getParameter("camaraname");
...
System.out.println(path);
        ...
        try {
            try {
             ...
             String sql = "insert into camara (camaraname,cid,brand,price,resolution,diplaysize,zoom,camarafeauture,ovfeauture,image)values('"+name+"','"+cid+"','"+brand+"','"+price+"','"+resolution+"','"+dsize+"','"+zoom+"', '"+fe+"','"+ov+"', '"+fileName+"')";
